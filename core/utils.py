...
def cpu_nms(boxes, scores, num_classes, max_boxes=50, score_thresh=0.5, iou_thresh=0.4):
    """
    /*----------------------------------- NMS on cpu ---------------------------------------*/
    Arguments:
    ...
    return boxes.tolist(), score.tolist(), label.tolist()

def cpu_nms_legacy(boxes, scores, num_classes, max_boxes=50, score_thresh=0.3, iou_thresh=0.5):
    """
    /*----------------------------------- NMS on cpu ---------------------------------------*/
    Arguments:
        boxes ==> shape [1, 10647, 4]
